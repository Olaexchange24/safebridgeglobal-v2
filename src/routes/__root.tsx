...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Safe Bridge RMB Exchange" },
      ...
      { name: "twitter:description", content: "Trusted RMB exchange platform for Nigerian importers. Pay Chinese suppliers safely, fund Alipay, WeChat Pay, and Chinese bank accounts with fast confirmation." },
      { property: "og:image", content: "https://safebridgeglobal.lovable.app/og-image.jpg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Safe Bridge RMB Exchange | Pay China Suppliers Safely" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&family=Space+Grotesk:wght@600;700&display=swap" },
    ],
  }),
